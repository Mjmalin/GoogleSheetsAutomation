...
After giving the program's service account editor rights to the spreadsheet we need, it connects by using a key generated by the service account. The key is saved in a file "credentials.json". 
